    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (bookBeans.pringBooks().length == 0) {
                out.println("<p>The Library is Empty \n</p>");
                out.println("<p>Please Add Books To View \n</p>");
            } else {
                ...
                int i, j;
                for (i = 0; i < bookBeans.pringBooks().length; i++) {
                    for (j = 0; j < 4; j++) {
                        if (j == 0) {
                            out.print("<tr>");
                        }
                        out.print("<td>" + bookBeans.pringBooks()[i][j] + "</td>\n");
                    }
                    out.print("<td>" + "    <form action=\"CartServlet\" method=\"post\">\n"
                            + "        <input type=\"hidden\" name=\"bookID\" value=\"" + bookBeans.pringBooks()[i][j - 4] + "\">\n"
